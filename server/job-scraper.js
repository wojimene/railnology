...
// --- FALLBACK DATA (High Quality Mock Data for Demos) ---
const FALLBACK_JOBS = [
    { 
    ...
    { 
        ...
        description: "Responsible for the safe movement of trains and rail cars. Outdoor work environment with heavy travel required.",
        jobType: "Full-time"
    },
    { 
        ...
        logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Brightline_logo.svg/2560px-Brightline_logo.svg.png",
...
const fetchRealJobs = async () => {
    ...
    try {
        ...
        return data.data.map(job => ({
            ...
            // Parse salary if available, otherwise default to null for frontend to handle
            ...
            logo: job.employer_logo || null, // API provides logo URLs
...
const scrape = async () => {
  try {
    ...
    console.log(`🎉 SUCCESS! ${newJobs.length} Full-Description Jobs Posted.`);
    process.exit();
  } catch (err) {
